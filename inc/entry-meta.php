...
function mf2_s_get_responses() {
	...
	if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) {
		...
		if ($comments!=0)
			{
				$c = '<span class="comments-count genericon genericon-comment" title="comments">';
				$c .= $comments;
				$c .= '</span> ';
			}
		// Webmentions Count
	...
	//	    }
		...
		if($likes!=0)
		     {	
			$c .= '<span class="like-count genericon genericon-like" title="likes">';
			$c .= $likes;
			$c .= '</span>';
		     }
		...
		if($favorites!=0)
		     {
            		$c .= '<span class="favorite-count genericon genericon-favorite" title="favorites">';
			$c .= $favorites;
               		$c .= '</span>';
		     }
 	       	...
 	       	if($repost!=0)
		     {
	                $c .= '<span class="repost-count genericon genericon-repost" title="repost">';
        	        $c .= $repost;
			$c .= '</span>';
		     }
 		$c .= '</span>';
